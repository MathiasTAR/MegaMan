...
if (_estado == "Idle") {
    ...
    // Limites laterais e inversão de direção
    if (x <= 35) {
        dir = 1;
    } else if (x >= 445) {
        dir = -1;
		    ...
		    switch (fase_ataque) {
		        ...
		        case 2: // Desce 
		            if (mover_para(pos_alvo[0], 400, 0.05)) {
		                ...
		                timer_fase = room_speed * 1.5; // pausa de 1,5 segundos
		            }
		        break;
		    ...
		    switch (fase_ataque) {
		        case 0:
		            ...
		            if (timer_fase <= 0 && penas_restantes > 0) {
		                ...
		                penas_restantes--; 
		                timer_fase = room_speed * 0.8; // intervalo entre as penas
		            ...
		            if (penas_restantes <= 0) {
		                fase_ataque = 1;
		                timer_fase = room_speed * 0.5; // tempo extra para animação
		            }
		        break;
...
//if (instance_exists(oPlayer)) {
//    oTuring.image_xscale = sign(oPlayer.x - oTuring.x);
//}
